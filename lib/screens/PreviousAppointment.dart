...
class PreviousAppointment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    QueryFirebaseMethod previous;
    previous = Provider.of<QueryFirebaseMethod>(context);
    return FutureBuilder(
      future:
          previous.getEventsHistory(Provider.of<Auth>(context).currentUser()),
...
class AppointmentCard extends StatelessWidget {
  final String title, paymentStatus, date, time, price;
  AppointmentCard(
